 ...
 * passkey components — unified-login Increment 3 Batch 4.
 *
 ...
 * build the bags from erevna's own `FM()` keys (under `auth.devicePin.*` /
 ...
 * matches a SINGLE-brace `{token}`. erevna's translation files, however, must

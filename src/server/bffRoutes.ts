/**
 * BFF downstream route table (Phase 2 — Step 4b cutover).
 *
 * After the cutover, erevna-web no longer talks to backend services
 * directly. Every API call goes same-origin to `bff-erevna`, which
 ...
 * entries in `Services/Bff.Erevna/src/Bff.Erevna/appsettings.json`.

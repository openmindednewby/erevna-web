/**
 * WCAG AA guard over the BADGE / CHIP / PILL pairs erevna actually renders,
 ...
 *
 * Erevna adds a second axis the agora guard does not need: a tenant picks one of
...
describe('erevna rendered badge contrast pairs (WCAG AA, every preset)', () => {

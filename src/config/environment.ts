...
const ENV = {
  dev: {
    ...
    KEYCLOAK_ISSUER: 'https://identity.dloizides.com/realms/questioner',
    KEYCLOAK_CLIENT_ID: 'online-menu-client',
    KEYCLOAK_REDIRECT_URI: 'http://localhost:8083',
    KEYCLOAK_SCOPES: 'openid profile email offline_access',
    USE_DIRECT_KC_AUTH: true,                         // Step 3 cutover — flip false to roll back
    APP_BASE_URL: 'http://localhost:8083',          // Public-facing base URL
  ...
  test: {
    ...
    KEYCLOAK_ISSUER: 'https://identity.dloizides.com/realms/questioner',
    KEYCLOAK_CLIENT_ID: 'online-menu-client',
    KEYCLOAK_REDIRECT_URI: 'https://erevna.dloizides.com',
    KEYCLOAK_SCOPES: 'openid profile email offline_access',
    USE_DIRECT_KC_AUTH: true,                         // Step 3 cutover — flip false to roll back
    APP_BASE_URL: 'https://erevna.dloizides.com',  // Public-facing base URL
    API_URL: 'https://erevna-api.dloizides.com',
...
function readDirectKcAuthOverride(): boolean | undefined {
  // Per-build override: `EXPO_PUBLIC_USE_DIRECT_KC_AUTH=false` rolls Step 3 back

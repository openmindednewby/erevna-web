 ...
 * URLs pointed at internal K8s DNS (`http://seaweedfs-s3:8333`) — and which
 * also bypassed the BFF entirely (cross-origin to `env.CONTENT_API_URL`),
 * which was CORS-blocked from the staging host.
 *

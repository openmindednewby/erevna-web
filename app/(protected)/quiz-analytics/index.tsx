...
import CrosstabTable from '../../../src/features/questioner/components/analytics/CrosstabTable';
import FunnelChart from '../../../src/features/questioner/components/analytics/FunnelChart';
...
import type { FunnelStats } from '../../../src/features/questioner/utils/analyticsTypes';
import type { CompletedQuestionerDto } from '../../../src/server/autoGeneratedHooks/questioner/models/completedQuestionerDto';
import type { Question } from '../../../src/server/autoGeneratedHooks/questioner/models/question';
...
const styles = StyleSheet.create({
  ...
  section: {
    marginBottom: TIMELINE_MARGIN_VERTICAL,
  },
  emptyContainer: {
...
const ReadyState = ({ stats, funnel, questions, matchingResponses }: ReadyStateProps): React.ReactElement => (
  <ScrollView contentContainerStyle={styles.content}>
    ...
    <View style={styles.section}>
      <CrosstabTable questions={questions} responses={matchingResponses} />
    </View>
...
const QuizAnalyticsPage = (): React.ReactElement => {
  ...
  const { colors } = theme;
  const { stats, funnel, questions, matchingResponses, activeTemplate, isLoading, refetch } = useQuizAnalytics();
  ...
  const renderBody = (): React.ReactElement => {
    ...
    return (
      <ReadyState funnel={funnel} matchingResponses={matchingResponses} questions={questions} stats={stats} />
    );
  };
